...
public class TodoViewModel extends AndroidViewModel {
    ...
    private  LiveData<List<Task>> mAllTodosByDate;
    ...
    public TodoViewModel(@NonNull Application application) {
        ...
        mAllTodosByDate =  mTodoRepository.getAllTodoListByDate();
    }
    ...
    public LiveData<List<Task>> getAllTodosByDate(){
        return mAllTodosByDate;
    }
