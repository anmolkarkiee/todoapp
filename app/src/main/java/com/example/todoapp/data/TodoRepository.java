...
public class TodoRepository {
    ...
    private LiveData<List<Task>> allTodoListByDate;
    ...
    public TodoRepository(Application application) {
        ...
        allTodoListByDate= mTodoDAO.getAllTodosByDate();
    }
    ...
    public LiveData<List<Task>> getAllTodoListByDate(){
        return allTodoListByDate;
    }
